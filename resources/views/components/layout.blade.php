...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body class="bg-white">
		<header class="bg-white lg:fixed lg:top-0 z-30 lg:drop-shadow w-full">
		...
		@endif
		<main class="relative max-w-7xl lg:mx-auto container  bg-white  p-4 items-center min-h-screen mt-16">
			{{$slot}}
		</main>
